...
- API keys (Finnhub, Alpha Vantage, Alpaca Markets)
  - **Alpaca:** Sign up at [alpaca.markets](https://alpaca.markets/) - Paper Trading or Live keys both work for market data
...
- `COINGECKO_API_KEY`
- `ALPACA_API_KEY_ID` (for options market data - paper or live keys both work)
- `ALPACA_API_SECRET_KEY` (for options market data - paper or live keys both work)
